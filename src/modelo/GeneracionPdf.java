...
public class GeneracionPdf {
    ...
    public void GeneracionPdfNominas(Nomina nomina, boolean extra) throws FileNotFoundException {
        ...
        cell2.add(new Paragraph("Bruto anual: "+String.format("%.2f",nomina.getBrutoAnual())));
...
//        cell11.setWidth(100);
        ...
        cell14.add(new Paragraph(String.valueOf(String.format("%.2f", nomina.getImporteSalarioMes()/30))).setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        tabla4.addCell(cell14.setBorder(SolidBorder.NO_BORDER));
        
        Cell cell15 = new Cell();
        cell15.add(new Paragraph(String.valueOf(String.format("%.2f", nomina.getImporteSalarioMes()))).setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        ...
        cell19.add(new Paragraph(String.valueOf(String.format("%.2f", nomina.getValorProrrateo()/30))).setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        tabla4.addCell(cell19.setBorder(SolidBorder.NO_BORDER));
        
        Cell cell20 = new Cell();
        cell20.add(new Paragraph(String.valueOf(String.format("%.2f", nomina.getValorProrrateo()))).setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        ...
        cell24.add(new Paragraph(String.format("%.2f", nomina.getImporteComplementoMes()/30)+"").setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        tabla4.addCell(cell24.setBorder(SolidBorder.NO_BORDER));
        
        Cell cell25 = new Cell();
        cell25.add(new Paragraph(String.format("%.2f", nomina.getImporteComplementoMes())).setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        ...
        if(nomina.getNumeroTrienios()==0){
            cell29.add(new Paragraph("00,00").setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        }else{
            cell29.add(new Paragraph(String.format("%.2f", nomina.getImporteTrienios()/nomina.getNumeroTrienios())+"").setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        }
        tabla4.addCell(cell29.setBorder(SolidBorder.NO_BORDER));
        
        Cell cell230 = new Cell();
        cell230.add(new Paragraph(String.format("%.2f", nomina.getImporteTrienios())+"").setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        ...
        cell33.add(new Paragraph(String.format("%.2f",nomina.getSeguridadSocialTrabajador())+"% de "+String.format("%.2f",nomina.getBaseEmpresario())).setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        ...
        cell36.add(new Paragraph(String.format("%.2f",nomina.getImporteSeguridadSocialTrabajador())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        ...
        cell38.add(new Paragraph(String.format("%.2f",nomina.getDesempleoTrabajador())+"% de "+String.format("%.2f",nomina.getBaseEmpresario())).setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        ...
        cell41.add(new Paragraph(String.format("%.2f",nomina.getImporteDesempleoTrabajador())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        ...
        cell43.add(new Paragraph(String.format("%.2f",nomina.getFormacionTrabajador())+"% de "+String.format("%.2f",nomina.getBaseEmpresario())).setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        ...
        cell46.add(new Paragraph(String.format("%.2f",nomina.getImporteFormacionTrabajador())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        ...
        cell48.add(new Paragraph(String.format("%.2f",nomina.getIrpf())+"% de "+String.format("%.2f",nomina.getBrutoNomina())).setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        ...
        cell51.add(new Paragraph(String.format("%.2f",nomina.getImporteIrpf())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        ...
        cell56.add(new Paragraph(String.format("%.2f",nomina.getImporteIrpf()+nomina.getImporteSeguridadSocialTrabajador()+nomina.getFormacionTrabajador()+nomina.getImporteDesempleoTrabajador())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        ...
        cell60.add(new Paragraph(String.format("%.2f",nomina.getBrutoNomina())+"").setTextAlignment(TextAlignment.CENTER).setFontSize(10));
        ...
        cell66.add(new Paragraph(String.format("%.2f",nomina.getLiquidoNomina())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        ...
        cell68.add(new Paragraph(String.format("%.2f",nomina.getBaseEmpresario())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        ...
        cell69.add(new Paragraph("Contingencias comunes empresario "+String.format("%.2f",nomina.getSeguridadSocialEmpresario())+"%").setTextAlignment(TextAlignment.LEFT).setFontSize(10));
        ...
        cell70.add(new Paragraph(String.format("%.2f",nomina.getImporteSeguridadSocialEmpresario())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        tabla5.addCell(cell70.setBorder(SolidBorder.NO_BORDER).setBorderTop(new SolidBorder(1)));
        
        Cell cell71 = new Cell();
        cell71.add(new Paragraph("Desempleo "+String.format("%.2f",nomina.getDesempleoEmpresario())+"%").setTextAlignment(TextAlignment.LEFT).setFontSize(10));
        tabla5.addCell(cell71.setBorder(SolidBorder.NO_BORDER));
        
        Cell cell72 = new Cell();
        cell72.add(new Paragraph(String.format("%.2f",nomina.getImporteDesempleoEmpresario())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        tabla5.addCell(cell72.setBorder(SolidBorder.NO_BORDER));
       
        
        Cell cell75 = new Cell();
        cell75.add(new Paragraph("Formación "+String.format("%.2f",nomina.getFormacionEmpresario())+"%").setTextAlignment(TextAlignment.LEFT).setFontSize(10));
        tabla5.addCell(cell75.setBorder(SolidBorder.NO_BORDER));
        
        Cell cell78 = new Cell();
        cell78.add(new Paragraph(String.format("%.2f",nomina.getImporteFormacionEmpresario())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        tabla5.addCell(cell78.setBorder(SolidBorder.NO_BORDER));
        
        Cell cell79 = new Cell();
        cell79.add(new Paragraph("Accidentes de trabajo "+String.format("%.2f",nomina.getAccidentesTrabajoEmpresario())+"%").setTextAlignment(TextAlignment.LEFT).setFontSize(10));
        tabla5.addCell(cell79.setBorder(SolidBorder.NO_BORDER));
        
        Cell cell80 = new Cell();
        cell80.add(new Paragraph(String.format("%.2f",nomina.getImporteAccidentesTrabajoEmpresario())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        tabla5.addCell(cell80.setBorder(SolidBorder.NO_BORDER));
        
        Cell cell81=  new Cell();
        cell81.add(new Paragraph("FOGASA "+String.format("%.2f",nomina.getFogasaempresario())+"%").setTextAlignment(TextAlignment.LEFT).setFontSize(10));
        tabla5.addCell(cell81.setBorder(SolidBorder.NO_BORDER));
        
        Cell cell82 = new Cell();
        cell82.add(new Paragraph(String.format("%.2f",nomina.getImporteFogasaempresario())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        ...
        cell84.add(new Paragraph(String.format("%.2f",nomina.getCosteTotalEmpresario())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10));
        ...
        cell86.add(new Paragraph(String.format("%.2f",nomina.getCosteTotalEmpresario()+nomina.getBrutoNomina())+"").setTextAlignment(TextAlignment.RIGHT).setFontSize(10).setFontColor(ColorConstants.RED));
